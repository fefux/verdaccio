...
$('#show-cache').on('change', function() {
  $('#all-packages').html("<img class='search-ajax' src='-/static/ajax.gif' alt='Spinner'/>")
  if (this.checked) {
    $('#all-packages').load('-/cached #all-packages');
  }
  else {
    $('#all-packages').load('/ #all-packages');
  }
})
...
$(function() {
  ;(function(window, document) {
    ...
    var $input         = $form.find('input.searched-text')
