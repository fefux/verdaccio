...
LocalData.prototype.add_cached = function(name) {
  if (this.data.cached.indexOf(name) === -1) {
    this.data.cached.push(name)
    this.sync()
  }
}
...
LocalData.prototype.remove_cached = function(name) {
  var i = this.data.cached.indexOf(name)
  if (i !== -1) {
    this.data.cached.splice(i, 1)
  }
...
LocalData.prototype.get_cached = function() {
